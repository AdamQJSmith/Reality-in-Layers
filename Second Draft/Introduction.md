...
*   **Layer 2: Biological (L2):** Arising from the physical, this is the layer of living systems, characterized by goal-directed functions such as homeostasis, metabolism, reproduction, and sensory transduction—processes that distinguish organisms from non-living entities like rocks or mountains in Layer 1. We study this layer differently than the physical, observing how organisms function. Critically, a key aspect of this layer is that it contains the biological faculties—sensory mechanisms, neural networks—that **enable, constrain, and determine** the potential for consciousness. This biological grounding does not extend to non-biological analogs (e.g., robot sensors), which remain reducible to Layer 1 unless evidence demonstrates equivalent living-like functionality.
