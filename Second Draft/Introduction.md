...
*   **Layer 2: Interactive Layer (L2):** This is the layer of interactive systems, encapsulating functions that enable subject-like engagement with the physical world, such as homeostasis, metabolism, reproduction, and sensory transduction (processes that create a distinct type from the non-living entities in Layer 1, including anything else that qualifies as these functions). Sensory mechanisms here are tied to these interactive systems; non-biological analogs (e.g., robot sensors) mimic aspects but are fully reducible to Layer 1 (e.g., metal, chips, electronic signals) and do not warrant extension unless evidence shows they give rise to genuine consciousness-like phenomena. We study this layer differently than the physical, observing how entities interact and function. Critically, a key aspect of this layer is that it contains the faculties (sensory mechanisms, neural networks) that **enable, constrain, and determine** the potential for consciousness.
