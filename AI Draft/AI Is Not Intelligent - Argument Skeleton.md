...
```mermaid
graph TD
    L1["Physical reality"] --> L2["Interactive and sensory life"]
    L2 --> L3["Subjective experience"]
    L3 --> L4["Shared constructs"]
    T["Existing shared constructs: language, art, code, theory"] --> M1["Physical computation"]
    M1 --> M2["Generated construct"]
    M2 --> L4
```
